        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          <div className={`space-y-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="inline-flex items-center space-x-2 bg-blue-100 border border-blue-300 rounded-full px-4 py-2 text-blue-700">
              <BookOpen className="w-4 h-4 fill-blue-600 text-blue-600" />
          ...
          <div className={`relative transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            <div className="relative h-[500px] lg:h-[600px]">
              ...
              <div className="absolute top-1/3 -right-8 w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg opacity-40 animate-float" style={{ animationDelay: '2s' }}></div>
            </div>
          </div>
        </div>
      </div>
