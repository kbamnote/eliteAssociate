...
export default function BlogHero() {
  ...
  const stats = [
    ...
    { icon: Eye, value: '100K+', label: 'Total Views' },
    { icon: Calendar, value: 'Daily', label: 'New Content' }
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          <div className={`space-y-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="inline-flex items-center space-x-2 bg-purple-100 border border-purple-300 rounded-full px-4 py-2 text-purple-700">
              <BookOpen className="w-4 h-4 fill-purple-600 text-purple-600" />
              <span className="text-sm font-medium">Knowledge Hub & Insights</span>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-600 leading-relaxed max-w-xl">
                Discover the latest trends, career advice, and industry insights. Our blog keeps you informed and inspired on your professional journey.
              </p>
            </div>
            ...
            <div className="relative h-[500px] lg:h-[600px]">
              ...
              <div className="relative h-full bg-gradient-to-br from-purple-100 to-purple-50 rounded-3xl border-2 border-purple-200 overflow-hidden shadow-2xl">
                ...
                <div className="absolute bottom-8 left-8 right-8 bg-white/95 backdrop-blur-md rounded-2xl p-6 border border-purple-200 shadow-xl">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <div className="text-gray-900 font-semibold text-lg">Fresh Content Daily</div>
                      <div className="text-gray-600 text-sm">Expert Articles & Career Tips</div>
                    </div>
                  </div>
                </div>
              ...
              <div className="absolute -top-4 -left-4 bg-white rounded-xl p-3 shadow-lg border border-purple-200 animate-float" style={{ animationDelay: '1s' }}>
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-semibold text-gray-900">Trending: AI Careers</span>
                </div>
              </div>

              {/* Blog Post Decoration */}
              <div className="absolute top-1/3 -right-8 w-16 h-16 bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg opacity-40 animate-float" style={{ animationDelay: '2s' }}></div>
            </div>
          </div>
        </div>
      </div>
