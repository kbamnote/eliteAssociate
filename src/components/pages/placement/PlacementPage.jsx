...
const PlacementPage = () => {
  const stats = [
    ...
    { number: "5000+", label: "Graduates Placed" },
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Career <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-700 to-indigo-700">Placement</span>
          </h1>
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {processSteps.map((step, index) => (
              ...
              >
                <div className="bg-purple-100 w-16 h-16 rounded-xl flex items-center justify-center text-purple-600 mx-auto mb-6">
                  {step.icon}
                </div>
            ...
            {successStories.map((story, index) => (
              ...
              >
                <div className="flex items-center gap-4 mb-6">
                  <div className="bg-gradient-to-r from-purple-500 to-indigo-600 w-16 h-16 rounded-full flex items-center justify-center text-white">
